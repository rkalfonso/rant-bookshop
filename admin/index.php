...
<head>
  ...
  <title>Rant Bookshop | Login</title>
...
<body class="hold-transition login-page">
      ...
      <div class="card-body login-card-body">
        ...
        <form action="validate.php" method="post">
          ...
          <div class="row">
            ...
            <!-- Login Button -->
            <div class="col-4">
              <input type="submit" class="btn btn-warning btn-block" name="submitted" value="Log In">
            </div>
            <!-- /Login Button -->
  ...
  <!-- AdminLTE App -->
  <script src="../AdminLTE-3.0.0-rc.4/dist/js/adminlte.min.js"></script>
</body>
